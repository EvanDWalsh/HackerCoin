...
static const int64 nTargetTimespan = 1 * 4 * 60 * 60; // HackerCoin: 4 hours
static const int64 nTargetSpacing = 60; // HackerCoin: 1 minute blocks
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Something coinciding wit the epoch eg like the first week of February 2014";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1391141796; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1345972;

        if (fTestNet)
        {
            block.nTime    = 1391141796;
            block.nNonce   = 440824;
        }
